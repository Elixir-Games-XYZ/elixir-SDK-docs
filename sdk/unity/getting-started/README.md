...
* Discover all the available [actions](../overlay/overlay-actions.md) you can do with it
* Use our [Event Simulator](../overlay/event-simulator/) to develop locally for a smooth integration
